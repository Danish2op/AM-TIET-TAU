...
### Route Map
*   `/` — Home: Compact hero, capability strip, image stack.
*   `/about` — About: Mission, TIET-TAU context, leadership profiles.
...
*   **Styling:** Write clean, vanilla CSS using predefined CSS variables in `src/styles.css`. Maintain the lab-tech visual hierarchy:
    *   Frosted glass overlays: `backdrop-filter: blur(12px) saturate(180%)`.
